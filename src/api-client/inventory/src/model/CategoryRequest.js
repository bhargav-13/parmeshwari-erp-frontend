...
class CategoryRequest {
    ...
    constructor(categoryName) { 
        ...
        CategoryRequest.initialize(this, categoryName);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CategoryRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CategoryRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CategoryRequest.RequiredProperties) {
...
CategoryRequest.RequiredProperties = ["categoryName"];

/**
 * @member {String} categoryName
 */
CategoryRequest.prototype['categoryName'] = undefined;
