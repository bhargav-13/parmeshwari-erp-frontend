    ...
    <div className="inventory-page">
      <div className="page-header">
        <div className="page-title-section">
          <h1 className="page-title">Stock Inventory - Ground Floor</h1>
          <p className="page-subtitle">Manage your ground floor product inventory and stock levels</p>
        </div>
      ...
      {isAddModalOpen && (
        <AddStockItemModal
          ...
          fixedFloor={InventoryFloor.GROUND_FLOOR}
        />
      )}
...
export default InventoryGroundFloorPage;
