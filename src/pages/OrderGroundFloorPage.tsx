...
const OrderGroundFloorPage: React.FC = () => {
  ...
  return (
    <div className="order-page">
      <div className="order-page-header">
        <div>
          <h1>Order Management - Ground Floor</h1>
          <p>Track confirmed orders and production status for ground floor.</p>
        </div>
      ...
      {isModalOpen && (
        <AddOrderModal
          ...
          fixedFloor={OrderFloor.GROUND_FLOOR}
        />
      )}
...
export default OrderGroundFloorPage;
